...
export function RecipeCreateScreen({
  ...
  const dirty = initiallyDirty || formDirty;

  useEffect(() => {
    // Imported content starts dirty because it is already meaningful unsaved
    // work; a pristine scratch draft exits without a discard prompt.
